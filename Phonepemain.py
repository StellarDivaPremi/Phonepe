...
# MENU 1 - HOME
if selected == "Home":
    st.markdown("# :violet[Phonepe  -India's Largest Payment Platform]")
    st.markdown("## :violet[Visualizations]")
...
if selected == "About":
    ...
    with col1:
        ...
        st.markdown("PhonePe retreats from ecommerce on ONDC; Good Glamm versus IAN Published on 24 Apr, 2024")
        st.write("https://economictimes.indiatimes.com/tech/newsletters/tech-top-5/phonepe-rejigs-ecommerce-strategy-good-glamm-vs-investor-battle-heats-up/articleshow/109567611.cms")
        
       
        
        st.write("**:Red[My Project GitHub link]** ⬇️")
        st.write("https://github.com/StellarDivaPremi/Phonepe")
        st.write("**:Red[Latest News about Phonepe]** ⬇️")
        st.write("https://economictimes.indiatimes.com/tech/phonepe")
